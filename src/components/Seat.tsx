...
export const Seat: React.FC<SeatProps> = ({
  ...
  const isHeldByUser = Boolean(isCurrentlyHeldByUser);
  const isHeldByOther = seat.status === 'held' && !isHeldByUser;
  const isAvailable = !isBooked && !isHeldByOther && !isHeldByUser;

  const isInteractive = (isAvailable || isCurrentlySelected || isHeldByUser) && !disabled;
